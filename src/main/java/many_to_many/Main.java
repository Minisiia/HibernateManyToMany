...
/**
 * Используя MySQL Workbench переписать базу данных так, чтобы одну книгу могли б написать несколько авторов, также один автор может написать несколько книг.
